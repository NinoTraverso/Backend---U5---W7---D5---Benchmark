...
namespace Inforno.Controllers
{
    public class ProdottiController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "IdProdotto,Nome,Foto,Costo,Preparazione,Ingredienti")] Prodotti prodotti)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "IdProdotto,Nome,Foto,Costo,Preparazione,Ingredienti")] Prodotti prodotti)
        {
            if (ModelState.IsValid)
            {
